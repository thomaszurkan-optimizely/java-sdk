...
interface NotificationListener {
    ...
    /**
     * This is the base method of notification.  Implementation classes such as [ActivateNotificationListener]
     * will implement this call and provide another method with the correct parameters
     * Notify called when a notification is triggered via the [com.optimizely.ab.notification.NotificationCenter]
     * @param args - variable argument list based on the type of notification.
     */
    fun notify(vararg args: Any)
}
