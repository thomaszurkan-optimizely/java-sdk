 ...
 */
(
        /** The ID of the [com.optimizely.ab.config.Variation] the user was bucketed into.  */
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val decision = o as Decision?

        return variationId == decision!!.variationId
    }
    ...
    fun toMap(): Map<String, String> {
        val decisionMap = HashMap<String, String>(1)
