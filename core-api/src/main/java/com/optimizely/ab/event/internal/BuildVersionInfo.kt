...
object BuildVersionInfo {
    ...
    private val logger = LoggerFactory.getLogger(BuildVersionInfo::class.java!!)

    val VERSION = readVersionNumber()
    private fun readVersionNumber(): String {
        val bufferedReader = BufferedReader(
                InputStreamReader(BuildVersionInfo::class.java!!.getResourceAsStream("/optimizely-build-version"),
